...
@section('content')
    ...
    <div class="min-h-screen bg-gradient-to-br from-white to-green-50 py-4 sm:py-6 lg:py-8" style="margin-top: 100px;">
                    ...
                    <div class="w-full max-w-4xl mx-auto">
                        ...
                        <div class="w-full flex flex-col sm:flex-row gap-3 justify-center">
                            ...
                            <a href="{{ route('programmes.all') }}"
                                class="bg-white border border-[#e94e1a] text-[#e94e1a] px-4 sm:px-6 py-3 rounded-lg sm:rounded-xl font-bold hover:bg-[#e94e1a] hover:text-white transition-all duration-300 flex items-center justify-center gap-2 text-sm sm:text-base">
