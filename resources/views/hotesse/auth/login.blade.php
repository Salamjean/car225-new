    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div class="p-8">
                ...
                <form action="{{ route('hotesse.auth.login.submit') }}" method="POST" class="space-y-6" novalidate>
                    @csrf

                    <!-- Login (Contact, Email ou Code ID) -->
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Contact, Email ou Code ID</label>
                        <div class="relative">
                            <input type="text" name="login" value="{{ old('login') }}" required
                                ...
                                placeholder="07xxxxxxxx, email@ex.com ou HTS-XXXXXX">
