...
<head>
    ...
    <title>Définir mot de passe - Hôtesse</title>
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div class="p-8">
                ...
                <form action="{{ route('hotesse.auth.setup-password.submit') }}" method="POST" class="space-y-6">
                    @csrf

                    <!-- Email (Read-only) -->
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Compte</label>
                        <input type="email" value="{{ session('hotesse_email_verified') }}" readonly
