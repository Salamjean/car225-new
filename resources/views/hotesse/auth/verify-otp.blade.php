...
<head>
    ...
    <title>Vérification OTP - Hôtesse</title>
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div class="p-8">
                ...
                <form action="{{ route('hotesse.auth.verify-otp.submit') }}" method="POST" class="space-y-6">
                    @csrf
                ...
                <!-- Resend OTP Form -->
                <form action="{{ route('hotesse.auth.resend-otp') }}" method="POST" id="resend-form" class="hidden">
                    @csrf
                ...
                <div class="mt-4 text-center border-t border-gray-200 pt-6">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="{{ route('hotesse.auth.login') }}" class="text-[#e94e1a] font-semibold hover:underline">
                            Se connecter
                        </a>
                    </p>
                </div>
