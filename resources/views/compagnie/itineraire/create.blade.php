...
<script>
    ...
    function enableSubmitButton() {
        ...
        if(btn) {
            ...
            btn.classList.add("bg-[#e94f1b]", "hover:bg-[#e89116]", "transform", "hover:-translate-y-1", "shadow-lg", "cursor-pointer"); 
        }
    }
    ...
    function disableSubmitButton() {
        ...
        if(btn) {
            ...
            btn.classList.remove("bg-[#e94f1b]", "hover:bg-[#e89116]", "transform", "hover:-translate-y-1", "shadow-lg", "cursor-pointer");
        }
    }
</script>
@endsection