                                        ...
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-12 w-12">
                                                @if ($personnel->profile_image)
                                                    ...
                                                    <div
                                                        class="h-12 w-12 rounded-full bg-[#e94f1b] flex items-center justify-center text-white font-bold text-sm hidden">
                                                        {{ substr($personnel->prenom, 0, 1) }}{{ substr($personnel->name, 0, 1) }}
                                                    </div>
                                                @else
                                                    <div
                                                        class="h-12 w-12 rounded-full bg-[#e94f1b] flex items-center justify-center text-white font-bold text-sm">
                                                        {{ substr($personnel->prenom, 0, 1) }}{{ substr($personnel->name, 0, 1) }}
                                                    </div>
                                                @endif
                                            </div>
