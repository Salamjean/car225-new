        ...
        <div class="mb-6 p-4 bg-yellow-50 border-l-4 border-yellow-500 rounded-xl">
            <div class="flex items-center">
                ...
                <p class="text-yellow-800 font-medium">
                    Attention : Il vous reste seulement <strong>{{ $caisse->tickets }}</strong> ticket(s). Pensez à demander un rechargement à votre compagnie.
                </p>
            </div>
        </div>
        @endif
            ...
            <form action="{{ route('caisse.vendre-ticket.submit') }}" method="POST" id="ticket-form">
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center">
                        ...
                        <input type="number" name="nombre_tickets" id="nombre_tickets" value="1" min="1" max="{{ $caisse->tickets }}" required
                        ...
                        <span class="ml-4 text-gray-600">/ {{ $caisse->tickets }} disponibles</span>
                    </div>
...
<script>
    const maxTickets = {{ $caisse->tickets }};
