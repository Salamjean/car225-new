...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-orange-50 py-8 px-4">
    <div class="mx-auto" style="width: 90%">
        ...
        <!-- Achat Rapide -->
        <div class="bg-gradient-to-r from-[#e94e1a] to-[#d33d0f] rounded-3xl shadow-lg p-8 text-white flex items-center justify-between hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 group cursor-pointer" onclick="window.location.href='{{ route('caisse.vendre-ticket') }}'">
            <div>
