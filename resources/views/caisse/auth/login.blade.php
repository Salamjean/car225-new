...
<head>
    ...
    <title>Connexion - Caissière</title>
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-[#e94e1a] to-[#d33d0f] p-8 text-center">
                ...
                <h1 class="text-3xl font-bold text-white mb-2">Espace Caissière</h1>
            ...
            <div class="p-8">
                ...
                <form action="{{ route('caisse.auth.login.submit') }}" method="POST" class="space-y-6" novalidate>
                    @csrf

                    <!-- Login (Email ou Code ID) -->
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Email ou Code ID</label>
                        <div class="relative">
                            <input type="text" name="login" value="{{ old('login') }}" required
                                ...
                                placeholder="votre@email.com ou CSS-XXXXXX">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('caisse.password.request') }}" class="text-sm text-[#e94e1a] hover:underline font-semibold">
                            Mot de passe oublié ?
                        </a>
                    </div>
