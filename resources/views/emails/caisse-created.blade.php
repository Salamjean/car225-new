...
<head>
    ...
    <title>Compte Caissière Créé</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Bonjour <strong>{{ $caisseData['prenom'] }} {{ $caisseData['name'] }}</strong>,</p>
            
            <p>Votre compte caissière a été créé avec succès par <strong>{{ $compagnieName }}</strong>.</p>
            ...
            <ol>
                ...
                <li>Connectez-vous et commencez à vendre des tickets</li>
            </ol>
