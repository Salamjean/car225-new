...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-orange-50 py-8 px-4">
    <div class="mx-auto" style="width: 90%">
        ...
        <div class="text-center mb-12">
            ...
            <h1 class="text-4xl font-bold text-gray-900 mb-3">Nouvelle Hotesse</h1>
            <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                Ajoutez une nouvelle hotesse et assignez-la à une compagnie
            </p>
        </div>

        <!-- Carte du formulaire -->
        <div class="bg-white rounded-3xl shadow-xl overflow-hidden">
            <form action="{{ route('admin.hotesse.store') }}" method="POST" enctype="multipart/form-data" class="p-8">
                @csrf

                <!-- Section: Sélection Compagnie -->
                <div class="mb-12">
                    <div class="flex items-center mb-6">
                        <div class="w-2 h-8 bg-green-500 rounded-full mr-4"></div>
                        <h2 class="text-2xl font-bold text-gray-900">Compagnie</h2>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <select name="compagnie_id" required
                                ...
                                @foreach($compagnies as $compagnie)
                                    <option value="{{ $compagnie->id }}" {{ old('compagnie_id') == $compagnie->id ? 'selected' : '' }}>
                                        {{ $compagnie->name }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-between items-center pt-8 border-t border-gray-200">
                    <a href="{{ route('admin.hotesse.index') }}" 
