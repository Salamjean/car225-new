        ...
        <div class=" mx-auto" style="width: 90%">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
                ...
                <a href="{{ route('compagnie.create') }}"
                    class="flex items-center px-6 py-3 bg-[#e94e1a] text-white font-semibold rounded-xl hover:bg-[#e89116] transform hover:-translate-y-1 transition-all duration-200 shadow-lg hover:shadow-xl mt-4 sm:mt-0">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center" style="display: flex; justify-content:center">
                                            <div class="flex-shrink-0 h-12 w-12">
                                                ...
                                                @else
                                                    <div
                                                        class="h-12 w-12 rounded-xl bg-[#e94e1a] flex items-center justify-center text-white font-bold text-sm">
            ...
            showButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    const logoHtml = compagnie.path_logo ?
                        ...
                        `<div class="w-32 h-32 rounded-2xl bg-[#e94e1a] flex items-center justify-center text-white font-bold text-2xl mx-auto mb-4">${compagnie.name.substring(0, 2)}</div>`;
                    ...
                    <div class="text-left">
                        ...
                        <div class="grid grid-cols-1 gap-3 text-xl text-center">
                            ${compagnie.sigle ? `<div><strong class="text-gray-700">Sigle:</strong> <span class="text-[#e94e1a] font-semibold">${compagnie.sigle}</span></div>` : ''}
