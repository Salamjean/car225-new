    ...
    <div class=" mx-auto" style="width: 90%">
        ...
        <div class="bg-white rounded-3xl shadow-xl overflow-hidden">
            <form action="{{ route('compagnie.update', $compagnie) }}" method="POST" enctype="multipart/form-data" class="p-8">
                ...
                <!-- Section 3: Gestion du Solde / Crédit -->
                <div class="mb-12">
                     <div class="flex items-center mb-6">
                        <div class="w-2 h-8 bg-blue-500 rounded-full mr-4"></div>
                        <h2 class="text-2xl font-bold text-gray-900">Gestion du Solde / Crédit</h2>
                    </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 bg-blue-50 p-6 rounded-2xl border border-blue-100">
                        <div class="flex flex-col justify-center">
                            ...
                            <div class="flex items-center gap-3">
                                <span class="text-4xl font-black text-blue-600">{{ number_format($compagnie->tickets, 0, ',', ' ') }}</span>
                                <span class="text-sm font-semibold text-blue-400 uppercase tracking-wider">FCFA disponible</span>
                            </div>
                        </div>

                        <div class="space-y-4">
                            <label class="block text-sm font-semibold text-gray-700">Recharger le compte (FCFA)</label>
                            <div class="flex gap-4">
                                <input type="number" name="add_tickets" min="0" placeholder="Montant à ajouter (Ex: 50000)"
                            ...
                            <p class="text-xs text-gray-500 italic">Entrez le montant en FCFA que vous souhaitez ajouter au solde de la compagnie.</p>
                        </div>
                    </div>
                </div>
