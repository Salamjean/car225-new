            ...
            @if($reservations->isEmpty())
                <div class="text-center py-5">
                    <div class="empty-state">
                        ...
                        <a href="{{ route('programme.index') }}" class="btn btn-primary" style="background-color: #fea219; border-color: #fea219;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="d-flex align-items-center" style="display: flex; justify-content:center">
                                                ...
                                                <div>
                                                    <span class="fw-bold">{{ number_format($reservation->montant_total, 0, ',', ' ') }} FCFA</span>
                                                    <div class="small text-muted">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <td class="align-middle" style="display: flex; justify-content:center">
                                            ...
                                            @if($reservation->embarquement_status == 'scanned')
                                                <div class="mt-1">
                                                    <span class="badge bg-info bg-opacity-10 text-white border border-info border-opacity-25 px-2 py-1 small">
