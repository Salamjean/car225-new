...
<div class="premium-container">
    <div class="max-w-5xl mx-auto">
        ...
        <div class="text-center mb-12 animate__animated animate__fadeInDown">
            <span class="inline-block px-4 py-1.5 bg-orange-100 text-orange-600 rounded-full text-xs font-black uppercase tracking-widest mb-4">Administration</span>
            <h1 class="text-5xl font-black text-gray-900 tracking-tight mb-4">Nouveau <span class="text-orange-600">Personnel</span></h1>
            <p class="text-gray-500 font-medium text-lg">Inscrivez un nouveau collaborateur au sein de votre gare.</p>
        </div>

        <form action="{{ route('gare-espace.personnel.store') }}" method="POST" enctype="multipart/form-data" class="animate__animated animate__fadeInUp">
            @csrf

            <div class="form-card-premium p-8 lg:p-12">
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    
                    {{-- Left Column: Avatar & Basic Roles --}}
                    <div class="lg:col-span-4 space-y-10">
                        ...
                        <div class="space-y-6">
                            <div class="input-group-premium">
                                <label class="label-premium">Type de personnel</label>
                                <select name="type_personnel" required class="floating-label-input">
                    ...
                    <div class="lg:col-span-8 space-y-12">
                        ...
                        <div>
                            <div class="section-header-premium">
                                ...
                                <h2 class="section-title">Identité du collaborateur</h2>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="input-group-premium">
                                    <label class="label-premium">Nom</label>
                                    <input type="text" name="name" value="{{ old('name') }}" required class="floating-label-input" placeholder="Ex: Sanogo">
                                ...
                                <div class="input-group-premium">
                                    ...
                                    <input type="text" name="prenom" value="{{ old('prenom') }}" required class="floating-label-input" placeholder="Ex: Moussa">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="input-group-premium">
                                    <label class="label-premium">Email Professionnel</label>
                                    <input type="email" name="email" value="{{ old('email') }}" required class="floating-label-input" placeholder="m.sanogo@compagnie.ci">
                                    @error('email') <p class="text-red-500 text-[10px] mt-1 font-bold uppercase">{{ $message }}</p> @enderror
                                </div>
                                <div class="input-group-premium">
                                    <label class="label-premium">Numéro de Téléphone</label>
                                    <div class="grid grid-cols-[100px_1fr] gap-2">
                                        <select name="country_code" class="floating-label-input !p-2 !text-xs">
                                            <option value="+225" selected>🇨🇮 +225</option>
                                            <option value="+33">🇫🇷 +33</option>
                                        </select>
                                        <input type="text" name="contact" value="{{ old('contact') }}" required class="floating-label-input" placeholder="0701020304" maxlength="10">
                                    </div>
                        ...
                        <div class="bg-red-50/50 p-6 lg:p-8 rounded-[2rem] border border-red-100">
                            ...
                            <div class="space-y-6">
                                <div class="input-group-premium">
                                    ...
                                    <input type="text" name="nom_urgence" value="{{ old('nom_urgence') }}" required class="floating-label-input" placeholder="Proche à contacter">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="input-group-premium">
                                        ...
                                        <select name="lien_parente_urgence" required class="floating-label-input">
                                            ...
                                            <option value="Père/Mère" {{ old('lien_parente_urgence') == 'Père/Mère' ? 'selected' : '' }}>Père/Mère</option>
                                            <option value="Frère/Sœur" {{ old('lien_parente_urgence') == 'Frère/Sœur' ? 'selected' : '' }}>Frère/Sœur</option>
                                            <option value="Oncle/Tante" {{ old('lien_parente_urgence') == 'Oncle/Tante' ? 'selected' : '' }}>Oncle/Tante</option>
                                    ...
                                    <div class="input-group-premium">
                                        <label class="label-premium">Contact Téléphonique</label>
                                        <div class="grid grid-cols-[100px_1fr] gap-2">
                                            <select name="country_code_urgence" class="floating-label-input !p-2 !text-xs">
                                                <option value="+225" selected>🇨🇮 +225</option>
                                                <option value="+33">🇫🇷 +33</option>
                                            </select>
                                            <input type="text" name="contact_urgence" value="{{ old('contact_urgence') }}" required class="floating-label-input" placeholder="Numéro d'urgence" maxlength="10">
                                        </div>
                                        @error('contact_urgence') <p class="text-red-500 text-[10px] mt-1 font-bold uppercase">{{ $message }}</p> @enderror
                                        @error('country_code_urgence') <p class="text-red-500 text-[10px] mt-1 font-bold uppercase">{{ $message }}</p> @enderror
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="mt-12 pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-6">
                    <a href="{{ route('gare-espace.personnel.index') }}" class="btn-back-premium">
                    ...
                    <button type="submit" class="btn-submit-premium">
                        ...
                        <span>Enregistrer le personnel</span>
                    </button>
                </div>
            </div>
        </form>
