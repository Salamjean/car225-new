...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-green-50 py-8 px-4">
    <div class=" mx-auto" style="width: 90%">
        ...
        <div class="bg-white rounded-3xl shadow-xl overflow-hidden">
            <form action="{{ route('gare-espace.itineraire.store') }}" method="POST" class="p-8" id="itineraireForm">
                @csrf
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input type="text" 
                                       ...
                                       name="point_depart" 
                                       required
                                       class="w-full px-4 py-4 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#e94f1b] focus:border-transparent transition-all duration-300 bg-gray-50 focus:bg-white pl-10"
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div id="route-stats" class="hidden flex space-x-4">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800">
                                <i class="fas fa-road mr-1"></i> <span id="distance-display">0 km</span>
                            </span>
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800">
                                <i class="fas fa-clock mr-1"></i> <span id="duration-display">0 min</span>
                            </span>
                        </div>
                    </div>
...
<script>
    ...
    function enableSubmitButton() {
        ...
        if(btn) {
            ...
            btn.classList.add("bg-[#e94f1b]", "hover:bg-[#d33d0f]", "transform", "hover:-translate-y-1", "shadow-lg", "cursor-pointer"); 
        }
    }
    ...
    function disableSubmitButton() {
        ...
        if(btn) {
            ...
            btn.classList.remove("bg-[#e94f1b]", "hover:bg-[#d33d0f]", "transform", "hover:-translate-y-1", "shadow-lg", "cursor-pointer");
        }
    }
</script>
@endsection
