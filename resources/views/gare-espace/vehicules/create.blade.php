    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-green-50 py-8 px-4">
        <div class=" mx-auto" style="width: 90%">
            ...
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden">
                <form action="{{ route('gare-espace.vehicules.store') }}" method="POST" class="p-8">
                    @csrf
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <select name="type_range" id="type_range" required
                                    ...
                                    <option value="2x2" {{ old('type_range') == '2x2' ? 'selected' : '' }}>2x2 (2 places par rangée)</option>
                                    <option value="2x3" {{ old('type_range') == '2x3' ? 'selected' : '' }}>2x3 (3 places par rangée)</option>
                                    <option value="2x4" {{ old('type_range') == '2x4' ? 'selected' : '' }}>2x4 (4 places par rangée)</option>
                                </select>
                                @error('type_range')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
