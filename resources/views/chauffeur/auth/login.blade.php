    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-[#e94e1a] to-[#d33d0f] p-8 text-center">
                ...
                <h1 class="text-3xl font-bold text-white mb-2">Espace Chauffeur</h1>
            ...
            <div class="p-8">
                ...
                <form action="{{ route('chauffeur.login.submit') }}" method="POST" class="space-y-6" novalidate>
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" name="login" value="{{ old('login') }}" required
                                ...
                                placeholder="votre@email.com ou CHF-XXXXXX">
