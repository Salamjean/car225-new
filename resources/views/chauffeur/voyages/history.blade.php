...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-orange-50 py-4 px-3 sm:py-8 sm:px-4">
    <div class="mx-auto" style="width: 100%">
        <div class="mb-4 sm:mb-8 flex flex-col md:flex-row md:items-center justify-between gap-3">
            <div>
                <h2 class="text-xl sm:text-3xl font-bold text-gray-900 mb-1 sm:mb-2">Historique de mes voyages</h2>
                <p class="text-gray-500 text-sm sm:text-lg">Liste exhaustive de vos courses effectuées ou prévues</p>
            </div>
            <!--
